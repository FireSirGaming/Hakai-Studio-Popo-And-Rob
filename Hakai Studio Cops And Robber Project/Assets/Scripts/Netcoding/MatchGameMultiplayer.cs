...
public class MatchGameMultiplayer : NetworkBehaviour
{
    ...
    private void Awake()
    {
        ...
        playerName = PlayerPrefs.GetString(PLAYER_PREFS_PLAYER_NAMEMULTIPLAYER, "PlayerName" + UnityEngine.Random.Range(100, 1000));
    ...
    public void SetPlayerName(string playerName)
    {
        ...
        PlayerPrefs.SetString(PLAYER_PREFS_PLAYER_NAMEMULTIPLAYER, playerName);
    }
